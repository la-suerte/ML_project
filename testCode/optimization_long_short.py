...
# ============================================================================
# PARAMETER GRID (TEST LONG-SHORT - AJOUT PAR SACHA)
# ============================================================================
PARAM_GRID = {
    'svd_rank': [4, 8, 12],        # On teste des rangs moyens
    'train_years': [3, 5],         # On teste sur 3 et 5 ans
    'test_months': [36],           # Test sur 3 ans
    'max_position': [0.10],        # Max 10% par position
